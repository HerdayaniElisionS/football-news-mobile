...
#ifndef FOOTBALL_NEWS_SWIFT_H
#define FOOTBALL_NEWS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="football_news",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC13football_news11AppDelegate")
...
SWIFT_CLASS("_TtC13football_news17MainFlutterWindow")
