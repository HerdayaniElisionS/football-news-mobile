...
SECRET_KEY = 'django-insecure-tk@qnjx(^bc0v(t5!l6pzol4v@!8x%@igh@#swj#%ls=_^6^2w'
...
ALLOWED_HOSTS = []
...
ALLOWED_HOSTS = ["localhost", "127.0.0.1", "herdayani-elision-footballnews.pbp.cs.ui.ac.id"]
...
...
